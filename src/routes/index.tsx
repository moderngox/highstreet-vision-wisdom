...
import productCeoAsset from "@/assets/pillar-look.jpg.asset.json";
const productCeo = productCeoAsset.url;
import productCeoImg from "@/assets/product-ceo.png";
...
const pillars = [
  ...
  { num: "05", key: "p5", img: productCeo, ratio: "aspect-[4/5]" },
] as const;
